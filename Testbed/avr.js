...
EmulatortHost.prototype = {
	...
	,installPortIOFunctions: function() {
		...
		outPort[34] = function(value) {
			...
			_gthis.ttyCharacters += String.fromCharCode(value);
			var tmp = HxOverrides.substr(_gthis.ttyCharacters,-40,null);
			_gthis.outputDiv.textContent = tmp;
		};
	...
	,reset: function() {
		...
		haxe_Log.trace("[Hay! reset]",{ fileName : "EmulatortHost.hx", lineNumber : 636, className : "EmulatortHost", methodName : "reset"});
	...
	,loadCodeChunks: function(chunks,debugData) {
		...
		haxe_Log.trace("loaded " + totalData + " bytes in total",{ fileName : "EmulatortHost.hx", lineNumber : 668, className : "EmulatortHost", methodName : "loadCodeChunks"});
