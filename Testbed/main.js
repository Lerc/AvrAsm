...
function init() {
  ...
  addTab("Main",files.Main);
  addTab("kwak8",files.kwak8);
  addTab("defs",files.defs);
  addTab("utility",files.utility);
  addTab("extra","");
